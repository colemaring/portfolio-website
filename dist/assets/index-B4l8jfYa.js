 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(n){function e(D,G){var H=D.length;D.push(G);e:for(;0<H;){var ie=H-1>>>1,z=D[ie];if(0<r(z,G))D[ie]=G,D[H]=z,H=ie;else break e}}function t(D){return D.length===0?null:D[0]}function i(D){if(D.length===0)return null;var G=D[0],H=D.pop();if(H!==G){D[0]=H;e:for(var ie=0,z=D.length,Q=z>>>1;ie<Q;){var se=2*(ie+1)-1,F=D[se],ce=se+1,he=D[ce];if(0>r(F,H))ce<z&&0>r(he,F)?(D[ie]=he,D[ce]=H,ie=ce):(D[ie]=F,D[se]=H,ie=se);else if(ce<z&&0>r(he,H))D[ie]=he,D[ce]=H,ie=ce;else break e}}return G}function r(D,G){var H=D.sortIndex-G.sortIndex;return H!==0?H:D.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;n.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();n.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,f=3,m=!1,_=!1,d=!1,p=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,x=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(D){for(var G=t(u);G!==null;){if(G.callback===null)i(u);else if(G.startTime<=D)i(u),G.sortIndex=G.expirationTime,e(l,G);else break;G=t(u)}}function y(D){if(d=!1,v(D),!_)if(t(l)!==null)_=!0,Z(w);else{var G=t(u);G!==null&&ee(y,G.startTime-D)}}function w(D,G){_=!1,d&&(d=!1,g(S),S=-1),m=!0;var H=f;try{for(v(G),h=t(l);h!==null&&(!(h.expirationTime>G)||D&&!W());){var ie=h.callback;if(typeof ie=="function"){h.callback=null,f=h.priorityLevel;var z=ie(h.expirationTime<=G);G=n.unstable_now(),typeof z=="function"?h.callback=z:h===t(l)&&i(l),v(G)}else i(l);h=t(l)}if(h!==null)var Q=!0;else{var se=t(u);se!==null&&ee(y,se.startTime-G),Q=!1}return Q}finally{h=null,f=H,m=!1}}var T=!1,A=null,S=-1,b=5,L=-1;function W(){return!(n.unstable_now()-L<b)}function K(){if(A!==null){var D=n.unstable_now();L=D;var G=!0;try{G=A(!0,D)}finally{G?U():(T=!1,A=null)}}else T=!1}var U;if(typeof x=="function")U=function(){x(K)};else if(typeof MessageChannel<"u"){var N=new MessageChannel,X=N.port2;N.port1.onmessage=K,U=function(){X.postMessage(null)}}else U=function(){p(K,0)};function Z(D){A=D,T||(T=!0,U())}function ee(D,G){S=p(function(){D(n.unstable_now())},G)}n.unstable_IdlePriority=5,n.unstable_ImmediatePriority=1,n.unstable_LowPriority=4,n.unstable_NormalPriority=3,n.unstable_Profiling=null,n.unstable_UserBlockingPriority=2,n.unstable_cancelCallback=function(D){D.callback=null},n.unstable_continueExecution=function(){_||m||(_=!0,Z(w))},n.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):b=0<D?Math.floor(1e3/D):5},n.unstable_getCurrentPriorityLevel=function(){return f},n.unstable_getFirstCallbackNode=function(){return t(l)},n.unstable_next=function(D){switch(f){case 1:case 2:case 3:var G=3;break;default:G=f}var H=f;f=G;try{return D()}finally{f=H}},n.unstable_pauseExecution=function(){},n.unstable_requestPaint=function(){},n.unstable_runWithPriority=function(D,G){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var H=f;f=D;try{return G()}finally{f=H}},n.unstable_scheduleCallback=function(D,G,H){var ie=n.unstable_now();switch(typeof H=="object"&&H!==null?(H=H.delay,H=typeof H=="number"&&0<H?ie+H:ie):H=ie,D){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=H+z,D={id:c++,callback:G,priorityLevel:D,startTime:H,expirationTime:z,sortIndex:-1},H>ie?(D.sortIndex=H,e(u,D),t(l)===null&&D===t(u)&&(d?(g(S),S=-1):d=!0,ee(y,H-ie))):(D.sortIndex=z,e(l,D),_||m||(_=!0,Z(w))),D},n.unstable_shouldYield=W,n.unstable_wrapCallback=function(D){var G=f;return function(){var H=f;f=G;try{return D.apply(this,arguments)}finally{f=H}}}})(Am);Cm.exports=Am;var jv=Cm.exports;/**
 * @license React
...
#endif`,k1="vec3 transformed = vec3( position );",F1=`vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vi,depthTest:!1,depthWrite:!1})}function zp(){return new Er({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:df(),fragmentShader:`
